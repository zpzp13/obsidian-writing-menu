...
export async function addCompactControl(_plugin: WritingMenuPlugin, container: HTMLElement, label: string, value: string, callback: (v: string) => void | Promise<void>, icon?: string, type: string = 'text'){
...
export async function addCompactToggle(_plugin: WritingMenuPlugin, container: HTMLElement, label: string, value: boolean, callback: (v: boolean) => void | Promise<void>, icon?: string){
	const div = container.createDiv('writing-menu-control');
	const labelGroup = div.createDiv('writing-menu-control-label-group');
	if (icon) {
		const iconSpan = labelGroup.createSpan('writing-menu-icon');
...
export async function addCompactStepper(_plugin: WritingMenuPlugin, container: HTMLElement, label: string, value: number, step: number, min: number, callback: (v: number) => void | Promise<void>, icon?: string){
...
export async function addCompactSlider(_plugin: WritingMenuPlugin, container: HTMLElement, label: string, value: number, min: number, max: number, step: number, callback: (v: number) => void | Promise<void>, icon?: string){
	const div = container.createDiv('writing-menu-control');
...
export async function addDualColorControl(_plugin: WritingMenuPlugin, container: HTMLElement, label: string, value: string | { light: string, dark: string }, callback: (v: string | { light: string; dark: string }) => void | Promise<void>, icon?: string){
	const div = container.createDiv('writing-menu-control');
