// Vendored from garu-ko@0.9.8 (pkg/garu_wasm.js) — https://github.com/ongjin/garu
// 이 파일만 번들에 포함하고, 무거운 .wasm/모델 바이너리는 첫 사용 시 CDN에서 내려받는다.
// garu-ko 버전을 올릴 때는 이 파일도 함께 갱신해야 한다.
